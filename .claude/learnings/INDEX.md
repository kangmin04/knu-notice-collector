...
- [onclick 기반 레거시 게시판 파싱과 정규식 캡처 그룹](html-onclick-legacy-navigation.md) — href가 죽은 값이고 onclick이 실제 이동을 담당하는 Struts/.action 게시판 패턴, 최신 사이트가 이걸 버린 이유(SEO·SPA pushState·CSP), match() 반환 배열과 캡처그룹 밀림 버그
